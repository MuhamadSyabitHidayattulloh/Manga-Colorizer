...
if (window.injectedMC !== 1) {
    ...
    const processMangaEventHandler = (event=null) => {
        try {
            chrome.storage.local.get(["apiURL", "maxActiveFetches", "showOriginal", "showColorized", "cache", "denoise", "colorize", "upscale", "denoiseSigma", "upscaleFactor", "translate", "srcLang", "destLang",
